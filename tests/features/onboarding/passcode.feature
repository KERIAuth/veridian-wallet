Feature: Passcode
  ...
  Background:
    ...
    And user accept Terms and Privacy Policy


  Scenario: C173 Passcode - loads correctly
    Then user can see Passcode screen

  Scenario: C174 Passcode - user can go back to Terms and Privacy screen
    Given user tap Cancel button on Passcode screen
    Then user can see Terms and Privacy screen
  ...
  Scenario: C176 PIN - user can start over
    Given user enter a generated passcode on Passcode screen
    And user can see Re-enter your PIN screen
    When user tap Can't remember button on Re-enter your PIN screen
    Then user can see PIN screen
  ...
  Scenario: C177 Passcode - user can set a new passcode
    ...
    Given user generated a password of 12 characters
    ...
    Then user can see Connect to Veridian screen
